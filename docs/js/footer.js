(() => {
    ...
    window.$docsify = window.$docsify || {}, window.$docsify.plugins = (window.$docsify.plugins || []).concat((function (o, f) {
        f.config.footer;
        let e = f.config.footer && f.config.footer.copy ? f.config.footer.copy : "<span>&copy; 2019.</span>",
            t = f.config.footer && f.config.footer.auth ? f.config.footer.auth : '<span>Published with <a href="https://github.com/docsifyjs/docsify" target="_blank" rel="noreferrer" rel="noopener">docsify</a>.</span>',
