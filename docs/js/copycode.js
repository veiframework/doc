...
!function () {
    ...
    !function (e, o) {
        ...
        var n = {buttonText: "Copy to clipboard", errorText: "Error", successText: "Copied"};
        o.doneEach((function () {
            ...
            e && e.addEventListener("click", (function (e) {
                if (e.target.classList.contains("docsify-copy-code-button")) {
                    var o = "BUTTON" === e.target.tagName ? e.target : e.target.parentNode, t = document.createRange(),
                        c = o.parentNode.querySelector("code"), i = o.querySelector("[aria-live]"),
